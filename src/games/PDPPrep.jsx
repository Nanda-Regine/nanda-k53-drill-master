...
const QUESTIONS = [
  ...
  { id: 'leg03', module: 'legislation', q: 'A PrDP (professional driving permit) is valid for a maximum of:', options: ['12 months','24 months','36 months','60 months'], answer: 1 },
  { id: 'leg04', module: 'legislation', q: 'Where do you apply for a PrDP in South Africa?', options: ['At a Driving Licence Testing Centre (DLTC)','At any SAPS police station','At the Post Office','At a private driving school'], answer: 0 },
  ...
  { id: 'leg08', module: 'legislation', q: 'In addition to a medical certificate, a PrDP application requires:', options: ['A police clearance / criminal record check','A letter from your employer','Ten years of accident-free driving','Proof of vehicle ownership'], answer: 0 },
  ...
  { id: 'leg10', module: 'legislation', q: 'Driving a vehicle that requires a PrDP without holding one is:', options: ['An offence — the driver and the operator can both be prosecuted','Allowed if you hold a normal driving licence','Only an offence for dangerous goods','Allowed within your home province'], answer: 0 },
  ...
  { id: 'leg12', module: 'legislation', q: 'What medical proof is required for a PrDP application?', options: ['A medical certificate from a registered medical practitioner (MED form), recently dated','No medical certificate is needed','A dental clearance','An eye test from any optician only'], answer: 0 },
  ...
  { id: 'leg14', module: 'legislation', q: 'Driving licence codes in South Africa are defined mainly by the vehicle\'s:', options: ['Gross vehicle mass (GVM)','Number of seats','Engine colour','Fuel type'], answer: 0 },
  ...
  { id: 'leg17', module: 'legislation', q: 'The main reason to manage a professional driver\'s working hours is to:', options: ['Prevent driver fatigue and crashes','Reduce fuel costs','Speed up deliveries','Avoid toll fees'], answer: 0 },
  ...
  { id: 'dg05', module: 'dangerous', q: 'The purpose of the emergency information panel (EIP) on a dangerous-goods vehicle is to:', options: ['Tell emergency responders what is carried and how to react','Advertise the transport company','Show the vehicle\'s kerb mass','Indicate the delivery route'], answer: 0 },
  ...
  { id: 'dg16', module: 'dangerous', q: 'When a dangerous-goods vehicle must be parked, the driver should:', options: ['Park in a safe, authorised area away from crowds and dwellings','Park as close to buildings as possible','Leave it unattended in any street overnight','Park on a pedestrian crossing for visibility'], answer: 0 },
  ...
  { id: 'acc05', module: 'accidents', q: 'At an accident scene involving a dangerous goods vehicle, the first priority is:', options: ['Collecting all documentation','Keeping bystanders and yourself well clear and upwind of the vehicle','Calling the insurance company','Taking photos of the placard'], answer: 1 },
  ...
  { id: 'acc13', module: 'accidents', q: 'By law, a driver who is INVOLVED in an accident must:', options: ['Stop, check whether anyone is hurt, and report the accident','Drive on if they are in a hurry','Only stop if their own vehicle is damaged','Wait for police before doing anything'], answer: 0 },
  ...
  { id: 'vi04', module: 'vehicle', q: 'Before moving off in a vehicle with air brakes, you must:', options: ['Wait until the system has built up enough air pressure and the low-air warning has gone off','Pump the brake pedal ten times','Rev the engine to 3000 rpm','Release the trailer brake first'], answer: 0 },
  ...
  { id: 'vi06', module: 'vehicle', q: 'A public transport or goods vehicle must pass a roadworthy test:', options: ['Once a year (annually)','Only when it is sold','Every five years','Never — once is enough'], answer: 0 },
  ...
  { id: 'vi09', module: 'vehicle', q: 'Excessive play or wear in the fifth-wheel / king-pin coupling:', options: ['Is dangerous — the trailer could detach; repair before use','Is normal and can be ignored','Only matters when fully loaded','Improves turning'], answer: 0 },
  ...
  { id: 'ps09', module: 'passengers', q: 'A public passenger-carrying vehicle must be equipped with:', options: ['A first-aid kit','A fire hose','Two spare wheels','A breathalyser'], answer: 0 },
  ...
  { id: 'ps12', module: 'passengers', q: 'Schoolchildren may NOT be transported for reward:', options: ['In the goods compartment (load bin) of a bakkie','In a licensed minibus with seats','In a bus fitted with seatbelts','In a car with an appropriate child restraint'], answer: 0 },
  ...
  { id: 'ec03', module: 'economy', q: 'If you are stopped for a long time (e.g. a lengthy train crossing), to save fuel you should:', options: ['Switch off the engine rather than idle','Keep revving to stay warm','Idle in gear with the clutch down','Leave the air-con on maximum'], answer: 0 },
  ...
  { id: 'ec06', module: 'economy', q: 'A clogged, dirty air filter mainly causes:', options: ['Reduced engine power and efficiency','Better fuel economy','Louder brakes','Brighter headlights'], answer: 0 },
